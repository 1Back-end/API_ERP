...
class User(Base):
    ...
    full_phone_number = Column(String,nullable=False)
    password_hash = Column(String, nullable=False)
    role=Column(String,nullable=False,default=UserRole.ADMIN)
    otp = Column(String,nullable=True,default=None)
    otp_password = Column(String,nullable=True,default=None)
    otp_password_expiry = Column(DateTime,nullable=True,default=None)
