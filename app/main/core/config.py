...
class ConfigClass(BaseSettings):
    ...
    ADMIN_KEY: str = get_secret("ADMIN_KEY", "enterprise_2025")
    ...
    SQLALCHEMY_DATABASE_URL: str = get_secret("SQLALCHEMY_DATABASE_URL", 'postgresql://postgres:2002@localhost:5432/api_management_erp')
    ...
    PROJECT_NAME: str = get_secret("PROJECT_NAME", "ENTERPRISE MANAGEMENT API")
